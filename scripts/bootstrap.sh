...
# Service Account Key Admin (for events init), iam.serviceAccountKeyAdmin
...
for role in iam.serviceAccount{Admin,TokenCreator,User,KeyAdmin} container.admin resourcemanager.projectIamAdmin compute.{loadBalancer,network,security}Admin firebaseauth.admin datastore.user; do
