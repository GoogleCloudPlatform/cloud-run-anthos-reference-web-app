...
import (
	"context"
	"flag"
	monitor "github.com/GoogleCloudPlatform/cloud-run-anthos-reference-web-app/inventory-level-monitor-service/src"
...
func main() {
	...
	m := *monitor.NewInventoryLevelMonitor(*backendClusterHostName)
